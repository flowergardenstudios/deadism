...
execute if score @s aj.tween_duration matches 0 on passengers run function animated_java:chrome_shotgun/animations/reload_load1/zzz/zzz/0 with entity @s data.uuids_by_name
