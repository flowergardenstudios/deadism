...
execute if entity @s[tag=aj.chrome_shotgun.animation.wall.playing] run function animated_java:chrome_shotgun/animations/wall/zzz/on_tick
execute on passengers run function animated_java:chrome_shotgun/root/on_tick/transform_floating_entities
execute on passengers run function animated_java:chrome_shotgun/root/zzz/0 with entity @s data.uuids_by_name