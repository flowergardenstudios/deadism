...
data modify entity @s data.uuids append from storage animated_java:gu out
data modify entity @s data.uuids_by_name.shotgun_shell set from storage animated_java:gu out
...
data modify entity @s data.uuids append from storage animated_java:gu out
data modify entity @s data.uuids_by_name.clock set from storage animated_java:gu out
...
data modify entity @s data.uuids append from storage animated_java:gu out
data modify entity @s data.uuids_by_name.trigger_part set from storage animated_java:gu out
...
data modify entity @s data.uuids append from storage animated_java:gu out
data modify entity @s data.uuids_by_name.chrome_shotgun set from storage animated_java:gu out
...
data modify entity @s data.uuids append from storage animated_java:gu out
data modify entity @s data.uuids_by_name.shotgun_shell1 set from storage animated_java:gu out
