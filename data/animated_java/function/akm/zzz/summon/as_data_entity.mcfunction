...
execute as @n[ type=minecraft:item_display, tag=aj.akm.locator.akm2, tag=aj.new, distance=..32 ] run function animated_java:akm/zzz/summon/as_data_entity/as_locator/akm2
data modify entity @s data.uuids append from storage animated_java:gu out
