...
execute if score @s aj.tween_duration matches 0 on passengers run function animated_java:akm/animations/run/zzz/zzz/0 with entity @s data.uuids_by_name
execute if score @s aj.run.frame matches -1 run function animated_java:akm/animations/run/zzz/function_keyframe_loop_patch
