execute on vehicle if entity @s[tag=deadism.Cautious] run return fail
...
execute if entity @s[tag=deadism.weapon.glock] on vehicle if entity @s[tag=deadism.IsWalking] run return run tag @s remove deadism.IsWalking

# // AKM
execute if entity @s[tag=deadism.weapon.akm] on vehicle if entity @s[tag=!deadism.IsWalking, predicate=deadism:key/forward] on passengers run function animated_java:akm/animations/walk/tween {to_frame: 0, duration: 7}
execute if entity @s[tag=deadism.weapon.akm] on vehicle if entity @s[tag=!deadism.IsWalking, predicate=deadism:key/forward] run return run tag @s add deadism.IsWalking
execute if entity @s[tag=deadism.weapon.akm] on vehicle if entity @s[tag=deadism.IsWalking] on passengers run function animated_java:akm/animations/equip/tween {to_frame: 30, duration: 5}
execute if entity @s[tag=deadism.weapon.akm] on vehicle if entity @s[tag=deadism.IsWalking, predicate=!deadism:key/forward] on passengers run function animated_java:akm/animations/equip/tween {to_frame: 30, duration: 5}
execute if entity @s[tag=deadism.weapon.akm] on vehicle if entity @s[tag=deadism.IsWalking] run return run tag @s remove deadism.IsWalking
...
execute if entity @s[tag=deadism.weapon.chrome_shotgun] on vehicle if entity @s[tag=deadism.IsWalking] run return run tag @s remove deadism.IsWalking
