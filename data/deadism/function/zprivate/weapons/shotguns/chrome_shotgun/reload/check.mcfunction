...
execute if score @s[tag=!deadism.weapon.cooldown] deadism.weapon.AMMO.RELOADABLE_AMOUNT matches ..0 as @n[predicate=deadism:id/weapons/id,tag=deadism.weapon.chrome_shotgun] run return run function animated_java:chrome_shotgun/animations/reload_end/play
