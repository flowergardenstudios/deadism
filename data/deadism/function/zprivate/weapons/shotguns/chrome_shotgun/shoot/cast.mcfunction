...
execute positioned ~-0.1 ~0.1 ~0.1 if entity @n[type=!#deadism:unalive, tag=!bullet.owner,dx=0,dy=4,dz=0] positioned ~-0.7 ~-0.7 ~-0.7 if entity @n[type=!#deadism:unalive, tag=!bullet.owner,dx=0,dy=4,dz=0] run return run function deadism:zprivate/weapons/shotguns/chrome_shotgun/shoot/damage
