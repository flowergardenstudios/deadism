...
execute if score @s deadism.weapon.AMMO.IN_GUN matches 1.. as @n[tag=deadism.weapon,predicate=deadism:id/weapons/id] run function animated_java:glock/animations/shoot/tween {to_frame:0, duration: 1}
execute if score @s deadism.weapon.AMMO.IN_GUN matches ..0 as @n[tag=deadism.weapon,predicate=deadism:id/weapons/id] run function animated_java:glock/animations/shoot_final/tween {to_frame:0, duration: 1}
