...
execute if score @s[tag=!deadism.weapon.cooldown] deadism.weapon.AMMO.IN_GUN matches ..0 as @n[tag=deadism.weapon,predicate=deadism:id/weapons/id] run return run function animated_java:glock/animations/reload_empty/play {to_frame:0, duration:5}
