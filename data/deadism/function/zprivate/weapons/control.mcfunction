...
execute if score @s deadism.weapon.EQUIPPED matches 4 unless items entity @s weapon.* *[custom_data~{deadism.weapon:1b,deadism.weapon.ID:4b}] run function deadism:zprivate/weapons/pistols/glock/unequip
...
execute unless score @s deadism.weapon.EQUIPPED matches 4 if items entity @s weapon.* poisonous_potato[custom_data~{deadism.weapon:1b,deadism.weapon.ID:4b}] run function deadism:zprivate/weapons/pistols/glock/equip
