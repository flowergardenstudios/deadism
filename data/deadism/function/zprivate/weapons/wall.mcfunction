...
execute as @n[tag=deadism.weapon.glock,predicate=deadism:id/weapons/id] at @s run return run function animated_java:glock/animations/idle/tween {to_frame: 1, duration: 3}
