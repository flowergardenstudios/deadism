...
execute as @s[tag=deadism.rope.ConnectToKnot2] positioned ~ ~ ~ align y if entity @n[distance=..0.5,type=!#deadism:unalive] run function deadism:zprivate/traps/rope/output
