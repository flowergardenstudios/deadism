...
execute as @s[tag=deadism.rope.ConnectToKnot2] positioned ~ ~ ~ align y if entity @n[type=#deadism:hostiles,distance=..0.1] run function deadism:zprivate/traps/rope/output
